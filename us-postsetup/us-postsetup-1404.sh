...
#
# script: us-postsetup-14.04.sh
# descripcion: Semiautomatiza tareas de post instalacion en ubuntu server 14.04
...
wget http://tuxjm.net/jm-confs/bash/root/1404dotbashrc
wget http://tuxjm.net/jm-confs/bash/root/1404dotbash_local
wget http://tuxjm.net/jm-confs/bash/root/1404dotbash_aliases
mv 1404dotbashrc .bashrc
mv 1404dotbash_local .bash_local
mv 1404dotbash_aliases .bash_aliases
source .profile

echo " Configurando el entorno del editor de textos vim para el usuario root"

wget http://tuxjm.net/jm-confs/vim/1404vimrc
mv 1404vimrc /root/.vimrc
...
wget http://tuxjm.net/jm-confs/apt/trusty-server/sources.list.us
wget http://tuxjm.net/jm-confs/apt/trusty-server/50tmpremount
wget http://tuxjm.net/jm-confs/apt/trusty-server/88apt-proxy
...
ethtool tcpdump tshark traceroute nmap elinks smbclient cifs-utils sysstat rsyslog

echo "Limpiando paquetes archivados de apt"
...
wget http://tuxjm.net/jm-confs/rsyslog/1404-50-default.conf
mv 1404-50-default.conf /etc/rsyslog.d/50-default.conf
/etc/init.d/rsyslog restart

echo "Configurando el servicio de sincronizacion de tiempo NTP"

cp /etc/ntp.conf{,.orig}
wget http://tuxjm.net/jm-confs/ntp/1404-ntp.conf
mv 1404-ntp.conf /etc/ntp.conf
...
wget http://tuxjm.net/jm-confs/snmp/1404-snmpd.conf
mv 1404-snmpd.conf /etc/snmp/snmpd.conf
...
wget http://tuxjm.net/jm-confs/sysstat/1404-default-sysstat
mv 1404-default-sysstat /etc/default/sysstat
